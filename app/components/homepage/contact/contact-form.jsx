...
import { contactsData } from "@/utils/data/contactsData"; // <-- Importing your email
...
function ContactForm() {
  ...
  const handleSendMail = (e) => {
    ...
    const mailtoLink = `mailto:${contactsData.email}?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
