...
function Navbar() {
  return (
    <nav className="fixed top-0 left-0 right-0 z-[9999] bg-[#0d1224]/80 backdrop-blur-md py-4 transition-all duration-300">
      <div className="flex items-center justify-between container mx-auto px-6 md:px-12 py-3">
